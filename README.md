...
- [`Find issue key`](https://github.com/marketplace/actions/jira-find-fint-issue-key) - Search for an issue key in commit message, branch name, etc. This issue key is then saved and used by the next actions in the same workflow
